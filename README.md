...
population. On note μ et σ2 la moyenne théorique et la variance théorique du rendement.
Après une étude statistique préalable (test de la normalité), on suppose raisonnablement
que la population admet une loi normale N(μ,σ2,$\pi$)avec les deux paramètres inconnus
